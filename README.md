...
* Ability to create, login to, and logout of my personal account.
* Ability to create, edit and delete personal entries.
...
* As a user, I expect to be able to efficiently create, login to, and logout of my personal account.
* As a user, I expect to be able to efficiently create, edit and delete personal entries.
...
* Provide users with a functional space to create, login to, and logout of a personal account.
* Provide users with a functional space to create, edit and delete personal entries.
...
* Be able to create, login to, and logout of my personal account.
* Be able to create, edit and delete personal entries.
...
* Can create, login to, and logout of my personal account.
* Can create, edit and delete personal entries effectively.
...
* #3F4238 Black Olive: I chose this as a header color because it has stark contrast and is easy to read. It
isn't quite black but it is close. 
* #6B705C Ebony: I chose this as a secondary text color because it is just different enough from Black Olive
to be easy to differentiate for users, but is still easy to read.
* #FFE8D6 Champagne Pink: I chose this to be the background color of the main journal entry text fields because,
...
* #CB997E Antique Brass: I chose this to be the main background color for the site because it is a calming color that
accents the other colors used nicely.
* #B98B73 Antique Brass: I chose this as a third level text color for links, buttons and highlighted text because it works
